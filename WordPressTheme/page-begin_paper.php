    ...
    <main class="paper">
        ...
        <div class="paper-middle">
            ...
            <div class="two-cols">
                <div class="left">
                    <h3>申請可能な手続き</h3>
                    <p>●国税・地方税に関する設立届 ●雇用に関する届出 ●定款認証・設立登記 ●GビズIDの発行</p>
                </div>
                <div class="right">
                    <h3>利用の際に必要なもの</h3>
                    <p>●法人代表者のマイナンバーカード ●マイナンバーカード対応のスマートフォンまたはパソコン ●ICカードリーダライタ（パソコンをご利用の方のみ）</p>
                </div>
            </div>

            <p>以上のように税理士に依頼せずに会社設立後の届出書類を提出する方法がありますが、やはり「よく分からない」「面倒」に感じられるかもしれません。</p>
            <p class="bold">
                そのような方には、会社設立後の届出書類<br>電子申請キャンペーンのご利用をおススメします。
            </p>
        </div>
